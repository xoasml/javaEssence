...
public class Source01_CalendarEx1 {
	public static void main(String[] args) {
		...
		System.out.println("이 달의 몇 째 요일 : " + today.get(Calendar.DAY_OF_WEEK_IN_MONTH)); // 이달의 다섯번 째 화요일
		...
		// 천분의 1초를 시간으로 표시하기 위해 360000으로 나누었다. (1시간 = 60 * 60초)
